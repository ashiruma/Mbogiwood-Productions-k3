      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-2xl">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-[#3B2F2F]">Welcome Back</CardTitle>
        ...
        <div className="text-center mt-6">
          <p className="text-white/80">
            ...
            <Link href="/auth/signup" className="text-[#4CAF50] hover:text-[#4CAF50]/80 font-semibold">
              Sign up here
            </Link>
          </p>
        </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/auth/forgot-password" className="text-sm text-[#4CAF50] hover:text-[#4CAF50]/80">
          Forgot password?
        </Link>
      </div>

      <Button type="submit" className="w-full bg-[#4CAF50] hover:bg-[#4CAF50]/90 text-white" disabled={isLoading}>
